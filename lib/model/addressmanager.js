...
AddressManager.create = function(opts) {
  ...
  x.fcashpayIndex = _.isNumber(opts.fcashpayIndex) ? opts.fcashpayIndex : Constants.BIP45_SHARED_INDEX;
...
AddressManager.fromObj = function(obj) {
  ...
  x.fcashpayIndex = obj.fcashpayIndex;
...
AddressManager.prototype.getBaseAddressPath = function(isChange) {
  return 'm/' +
    (this.derivationStrategy == Constants.DERIVATION_STRATEGIES.BIP45 ? this.fcashpayIndex + '/' : '') +
    (isChange ? 1 : 0) + '/' +
    0;
};
