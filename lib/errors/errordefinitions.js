...
var errors = {
  ...
  COPAYER_DATA_MISMATCH: 'FcashApp data mismatch',
  COPAYER_IN_WALLET: 'FcashApp already in wallet',
  COPAYER_REGISTERED: 'FcashApp ID already registered on server',
  COPAYER_VOTED: 'FcashApp already voted on this transaction proposal',
