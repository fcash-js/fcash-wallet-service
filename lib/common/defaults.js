...
// Time after which a tx proposal can be erased by any fcashpay. in seconds
Defaults.DELETE_LOCKTIME = 600;

// Allowed consecutive txp rejections before backoff is applied.
Defaults.BACKOFF_OFFSET = 10;

// Time a fcashpay need to wait to create a new tx after her previous proposal was rejected. in seconds.
