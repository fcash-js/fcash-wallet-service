...
var FcashApp = require('../../lib/model/fcashpay');


describe('FcashApp', function() {

  describe('#fromObj', function() {
    it('read a fcashpay', function() {
      var c = FcashApp.fromObj(testWallet.fcashpay[0]);
      c.name.should.equal('fcashpay 1');
    });
  });
  describe('#createAddress', function() {
    it('should create an address', function() {
      var w = Wallet.fromObj(testWallet);
      var c = FcashApp.fromObj(testWallet.fcashpay[2]);
