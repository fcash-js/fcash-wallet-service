...
var FcashApp = require('../../lib/model/fcash-pay');


describe('FcashApp', function() {

  describe('#fromObj', function() {
    it('read a fcash-pay', function() {
      var c = FcashApp.fromObj(testWallet.fcash-pay[0]);
      c.name.should.equal('fcash-pay 1');
    });
  });
  describe('#createAddress', function() {
    it('should create an address', function() {
      var w = Wallet.fromObj(testWallet);
      var c = FcashApp.fromObj(testWallet.fcash-pay[2]);
